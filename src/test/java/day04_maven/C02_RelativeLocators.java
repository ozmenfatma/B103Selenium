...
//        Sayfadaki Berlin WE'ini  relative locator ile tiklayalim
        ...
        //relative locator da ortak tagname ile ulasiyoruz

      WebElement BerlionWE= driver.findElement(with(By.tagName("li")).below(NYCWebElement).toLeftOf(BayAreaWebelement));
     BerlionWE.click();
    }
}
